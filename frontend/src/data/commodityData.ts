...
const generatePriceHistory = (currentPrice: number, volatility: number, minPrice?: number, maxPrice?: number): PricePoint[] => {
...
const generateRegionalPrices = (basePrice: number, minPrice?: number, maxPrice?: number): RegionalPrice[] => {
  ...
  return regions.map(region => {
    ...
    switch(region) {
      case 'Dhaka':
        ...
        varianceFactor = 1 + (Math.random() * 0.10); 
        break;
      case 'Chittagong':
    ...
    return {
      region: region,
      price: price,
      change: Math.round(varianceFactor > 1 ? (varianceFactor - 1) * 100 : (varianceFactor - 1) * 100)
    };
  });
};
...
export const commodities: Commodity[] = [
  {
    ...
    minPrice: 75,
    maxPrice: 80,
    get regionalPrices() { return generateRegionalPrices(77, this.minPrice, this.maxPrice); },
    get currentPrice() { return calculateAveragePrice(this.regionalPrices); },
    get previousPrice() { return Math.round(this.currentPrice * 0.97); }, // Approximate previous price
    weeklyChange: 2.6,
    monthlyChange: 4.0,
    yearlyChange: 15.4,
    description: 'Premium quality rice varieties including Miniket and Najirshail',
    image: '/images/commodities/rice-fine.jpg',
    get priceHistory() { return generatePriceHistory(this.currentPrice, 0.04, this.minPrice, this.maxPrice); },
    get supplyChainData() { return generateSupplyChainData(this.currentPrice); }
  },
  {
    id: '2',
    name: 'Rice (Medium)',
    ...
    minPrice: 60,
    maxPrice: 68,
    get regionalPrices() { return generateRegionalPrices(64, this.minPrice, this.maxPrice); },
    get currentPrice() { return calculateAveragePrice(this.regionalPrices); },
    get previousPrice() { return Math.round(this.currentPrice * 0.96); },
    weeklyChange: 3.2,
    monthlyChange: 4.9,
    yearlyChange: 12.8,
    description: 'Medium quality rice varieties including Paijam',
    image: '/images/commodities/rice-medium.jpg',
    get priceHistory() { return generatePriceHistory(this.currentPrice, 0.03, this.minPrice, this.maxPrice); },
    get supplyChainData() { return generateSupplyChainData(this.currentPrice); }
  },
  {
    id: '3',
    ...
    minPrice: 55,
    maxPrice: 62,
    get regionalPrices() { return generateRegionalPrices(58, this.minPrice, this.maxPrice); },
    get currentPrice() { return calculateAveragePrice(this.regionalPrices); },
    get previousPrice() { return Math.round(this.currentPrice * 0.96); },
    weeklyChange: 3.6,
    monthlyChange: 5.5,
    ...
    get priceHistory() { return generatePriceHistory(this.currentPrice, 0.025, this.minPrice, this.maxPrice); },
    get supplyChainData() { return generateSupplyChainData(this.currentPrice); }
  },
  {
    id: '4',
    ...
    minPrice: 48,
    maxPrice: 54,
    get regionalPrices() { return generateRegionalPrices(51, this.minPrice, this.maxPrice); },
    get currentPrice() { return calculateAveragePrice(this.regionalPrices); },
    get previousPrice() { return Math.round(this.currentPrice * 1.04); }, // Price was higher before
    weeklyChange: -3.8,
    monthlyChange: -5.0,
    yearlyChange: 7.5,
    description: 'Fine wheat flour used for making breads and pastries',
    image: '/images/commodities/wheat-flour.jpg',
    get priceHistory() { return generatePriceHistory(this.currentPrice, 0.05, this.minPrice, this.maxPrice); },
    get supplyChainData() { return generateSupplyChainData(this.currentPrice); }
  },
  {
    id: '5',
    ...
    minPrice: 53,
    maxPrice: 60,
    get regionalPrices() { return generateRegionalPrices(56, this.minPrice, this.maxPrice); },
    get currentPrice() { return calculateAveragePrice(this.regionalPrices); },
    get previousPrice() { return Math.round(this.currentPrice * 1.05); },
    weeklyChange: -5.2,
    monthlyChange: -6.2,
    yearlyChange: 8.2,
  ...
  },
  {
    ...
    minPrice: 75,
    maxPrice: 95,
    get regionalPrices() { return generateRegionalPrices(85, this.minPrice, this.maxPrice); },
    get currentPrice() { return calculateAveragePrice(this.regionalPrices); },
    get previousPrice() { return Math.round(this.currentPrice * 0.92); },
    weeklyChange: 9.0,
    monthlyChange: 15.2,
    yearlyChange: -12.5,
    description: 'Locally grown onions from Bangladesh',
    image: '/images/commodities/onion-local.jpg',
    get priceHistory() { return generatePriceHistory(this.currentPrice, 0.15, this.minPrice, this.maxPrice); },
    get supplyChainData() { return generateSupplyChainData(this.currentPrice); }
  },
  {
    id: '13',
    ...
    minPrice: 65,
    maxPrice: 85,
    get regionalPrices() { return generateRegionalPrices(73, this.minPrice, this.maxPrice); },
    get currentPrice() { return calculateAveragePrice(this.regionalPrices); },
    get previousPrice() { return Math.round(this.currentPrice * 1.07); },
    weeklyChange: -6.7,
    monthlyChange: -8.5,
    yearlyChange: -15.5,
    description: 'Imported onions primarily from India',
    image: '/images/commodities/onion-imported.jpg',
    get priceHistory() { return generatePriceHistory(this.currentPrice, 0.18, this.minPrice, this.maxPrice); },
    get supplyChainData() { return generateSupplyChainData(this.currentPrice); }
  },
  {
    id: '14',
    ...
    minPrice: 28,
    maxPrice: 38,
    get regionalPrices() { return generateRegionalPrices(33, this.minPrice, this.maxPrice); },
    get currentPrice() { return calculateAveragePrice(this.regionalPrices); },
    get previousPrice() { return Math.round(this.currentPrice * 1.09); },
    weeklyChange: -8.6,
    monthlyChange: -9.1,
    yearlyChange: 5.2,
    description: 'Fresh potatoes from northern regions of Bangladesh',
    image: '/images/commodities/potato.jpg',
    get priceHistory() { return generatePriceHistory(this.currentPrice, 0.12, this.minPrice, this.maxPrice); },
    get supplyChainData() { return generateSupplyChainData(this.currentPrice); }
  },
  {
    id: '15',
  ...
  },
  {
    ...
    minPrice: 120,
    maxPrice: 180,
    get regionalPrices() { return generateRegionalPrices(150, this.minPrice, this.maxPrice); },
    get currentPrice() { return calculateAveragePrice(this.regionalPrices); },
    get previousPrice() { return Math.round(this.currentPrice * 0.84); },
    weeklyChange: 19.2,
    monthlyChange: 27.3,
    yearlyChange: -5.4,
    description: 'Fresh green chilies grown locally',
    image: '/images/commodities/green-chili.jpg',
    get priceHistory() { return generatePriceHistory(this.currentPrice, 0.25, this.minPrice, this.maxPrice); },
    get supplyChainData() { return generateSupplyChainData(this.currentPrice); }
  },
  {
    id: '18',
  ...
  },
  {
    ...
    priceHistory: generatePriceHistory(1200, 0.10),
    regionalPrices: generateRegionalPrices(1200),
    supplyChainData: generateSupplyChainData(1200)
  },
  {
...
export const getTopChangedCommodities = (limit: number = 5): Commodity[] => {
  return [...commodities].sort((a, b) => Math.abs(b.weeklyChange) - Math.abs(a.weeklyChange)).slice(0, limit);
};
